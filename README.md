...
<video src="https://blog.naver.com/lsh2757/223223096771"> width="1000" controls autoplay>q</video>
 ...
 * 예약은 해당 도서의 책 id를 파라미터로 받아왔다. 예약취소소는 도서 id 값을 파라미터로 잡은 후 해당하는 id의 예약 도서를 삭제한다.
