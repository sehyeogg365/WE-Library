...
<body>
	<nav class="side-nav2 col-3">
		...
		<ul class="nav flex-column mt-4 "> 
			...
			<li class="nav-item"><div class="font-weight-bold" style="font-size :18px;"><a href="/book/borrowstatus/view?id=${userId }" class="nav-link text-dark">도서이용정보</a></div><hr></li>
			<li class="nav-item"><div class="font-weight-bold" style="font-size :18px;"><a href="/book/interestbooklist/view?id=${userId }" class="nav-link text-dark">관심자료 목록</a></div><hr></li>
